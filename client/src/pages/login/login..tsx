    ...
    return (
        <div className="pb-15">
            <div className="bg-black text-white flex flex-col items-center py-8 lg:py-12 gap-3">
                <h1 className="text-2xl lg:text-6xl font-semibold">Trang đăng nhập tài khoản</h1>
            ...
            <div className="flex flex-col lg:flex-row lg-container mx-auto py-10 px-5 xl:px-0">
                ...
                <div className="flex-1 text-center space-y-4 lg:ps-15 lg:border-s lg:border-gray-300">
                    ...
                    <p className="font-light">
                        Đăng ký tại trang web này cho phép bạn truy cập trạng thái và lịch sử đơn hàng của mình.
                        Chỉ cần điền vào các trường bên dưới, và chúng tôi sẽ thiết lập một tài khoản mới cho bạn ngay lập tức.
