        ...
        <>
            <div className="min-h-screen bg-gray-50/50 pb-24">
                <div className="sm-container mx-auto space-y-5 py-8">
                    ...
                    {/* Page header */}
                    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-7 py-5 shadow-sm">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                <button
                                    type="button"
                                    onClick={() => navigate("/page/orders")}
                                    className="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 text-gray-500 transition hover:bg-gray-50"
                                >
                                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7"/></svg>
                                </button>
                                <div>
                                    <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400">Chi tiết đơn hàng</p>
                                    <h1 className="mt-0.5 font-mono text-lg font-bold text-gray-800 leading-snug">{uuid}</h1>
                                </div>
                            </div>
                            {order && statusMeta && (
                                <span className={`inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-sm font-semibold ${statusMeta.badgeBg} ${statusMeta.color}`}>
